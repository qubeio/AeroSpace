...
== reset-workspace-bsp
----
include::aerospace-reset-workspace-bsp.adoc[tags=synopsis]
----
include::aerospace-reset-workspace-bsp.adoc[tags=purpose]
include::aerospace-reset-workspace-bsp.adoc[tags=body]
...
=== debug-tree
----
include::aerospace-debug-tree.adoc[tags=synopsis]
----
include::aerospace-debug-tree.adoc[tags=purpose]
include::aerospace-debug-tree.adoc[tags=body]
